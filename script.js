document.addEventListener('DOMContentLoaded', () => {
    ...
    const civicData = {
        national: {
            total: 125432, resolved: 98765, cleanliness: 8.2, avgTime: 9.5,
            categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [35000, 22000, 18000, 15000, 28000, 7432] }
        },
        states: {
            "Odisha": {
                total: 8500, resolved: 7200, cleanliness: 8.8, avgTime: 8.2,
                categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [2200, 1500, 1100, 900, 1800, 1000] },
                cities: {
                    "Bhubaneswar": { total: 4200, resolved: 3800, cleanliness: 9.1, avgTime: 7.8, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [1100, 800, 500, 400, 900, 500] } },
                    "Cuttack": { total: 2800, resolved: 2100, cleanliness: 8.5, avgTime: 9.1, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [800, 500, 400, 350, 600, 150] } },
                    "Puri": { total: 1500, resolved: 1300, cleanliness: 8.9, avgTime: 6.9, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [300, 200, 200, 150, 300, 350] } }
                }
            },
            "Maharashtra": {
                total: 15200, resolved: 12500, cleanliness: 9.2, avgTime: 10.1,
                categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [4500, 3000, 2500, 1800, 2400, 1000] },
                cities: {
                    "Mumbai": { total: 7500, resolved: 6000, cleanliness: 9.0, avgTime: 11.2, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [2500, 1500, 1200, 800, 1000, 500] } },
                    "Pune": { total: 5200, resolved: 4500, cleanliness: 9.4, avgTime: 8.5, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [1500, 1000, 900, 600, 900, 300] } },
                    "Navi Mumbai": { total: 2500, resolved: 2320, cleanliness: 9.7, avgTime: 7.2, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [500, 500, 400, 400, 500, 200] } }
                }
            },
            "Gujarat": {
                total: 9800, resolved: 8900, cleanliness: 9.5, avgTime: 7.5,
                categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [2800, 1800, 1500, 1200, 1900, 600] },
                cities: {
                    "Ahmedabad": { total: 4500, resolved: 4000, cleanliness: 9.3, avgTime: 8.0, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [1300, 900, 700, 600, 800, 200] } },
                    "Surat": { total: 5300, resolved: 4900, cleanliness: 9.8, avgTime: 6.8, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [1500, 900, 800, 600, 1100, 400] } }
                }
            }
        },
        pincodes: {
            "751001": { state: "Odisha", city: "Bhubaneswar", total: 150, resolved: 142, cleanliness: 9.5, avgTime: 7.2, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [40, 30, 20, 10, 35, 17] }},
            "400001": { state: "Maharashtra", city: "Mumbai", total: 210, resolved: 180, cleanliness: 8.9, avgTime: 11.5, categories: { labels: ['Sanitation', 'PWD', 'Water', 'Electricity', 'Traffic', 'Municipal'], values: [60, 45, 30, 20, 40, 15] }}
        }
    };
    ...
    function updateDashboardDisplay(data, locationName) {
        ...
        document.getElementById('avg-resolution-time').textContent = data.avgTime ? `${data.avgTime} Hours` : 'N/A';
